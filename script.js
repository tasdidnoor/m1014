...
const questionData = {
    ...
    "11.1-19": { text: "{ -3, 2, -4/3, 8/9, -16/27, ... }. Find a formula for a<sub>n</sub>.", answer: "((-1)^n * (2^n-1)) / 3^(n-2)" },
    "11.1-22": { text: "{ 1, 0, -1, 0, 1, 0, -1, 0, ... }. Find a formula for a<sub>n</sub>.", answer: "sin(nπ/2)" },
    ...
    "11.1-28": { text: "a<sub>n</sub> = 5<span class='math-sqrt-symbol'>√</span><span class='math-sqrt'>n + 2</span>. Determine convergence or divergence; if converges, find limit.", type: "limit", answer: "diverges" },
    ...
    "11.2-23": { text: "Determine if the geometric series converges or diverges: 3 - 4 + <div class='math-frac'><span class='top'>16</span><span class='bottom'>3</span></div> - <div class='math-frac'><span class='top'>64</span><span class='bottom'>9</span></div> + ...", type: "limit", answer: "diverges" },
    "11.2-24": { text: "Determine if the geometric series converges or diverges: <div class='math-frac'><span class='top'>9</span><span class='bottom'>4</span></div> + <div class='math-frac'><span class='top'>27</span><span class='bottom'>16</span></div> + ...", type: "limit", answer: "9" },
